...
#define OPTEE_FFA_YIELDING_CALL(id)	((id) | (1U << OPTEE_FFA_YIELDING_CALL_BIT))
 ...
 */
#define OPTEE_FFA_SEC_CAP_ARG_OFFSET	(1 << 0)
/* OP-TEE supports asynchronous notification via FF-A */
#define OPTEE_FFA_SEC_CAP_ASYNC_NOTIF	(1 << 1)
/* OP-TEE supports probing for RPMB device if needed */
#define OPTEE_FFA_SEC_CAP_RPMB_PROBE	(1 << 2)
/* OP-TEE supports Protected Memory for secure data path */
#define OPTEE_FFA_SEC_CAP_PROTMEM	(1 << 3)
